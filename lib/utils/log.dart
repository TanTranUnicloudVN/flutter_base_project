  ...
  DebugLogger._internal() {
    _loggerBloc = Logger(
      printer: CustomPrinter(
          ...
          errorMethodCount:
              0, // number of method calls if stacktrace is provided
          lineLength: 12, // width of the output
...
class CustomPrinter extends LogPrinter {
  ...
  Object toEncodeFallback(dynamic object) {
  ...
  String stringifyMessage(dynamic message) {
    ...
    if (finalMessage is Map || finalMessage is Iterable) {
      var encoder = JsonEncoder.withIndent('  ', toEncodeFallback);
  ...
  AnsiColor _getErrorColor(Level level) {
    if (colors) {
      if (level == Level.wtf) {
        ...
        return levelColors[Level.error]!.toFg();
      }
    } else {
      return AnsiColor.none();
    }
